...
def frame_embedding(frame_indices, dim,
                    max_period):  # max_period should be several times T
    ...
    return timestep_embedding(frame_indices.reshape(-1),
                              dim=dim,
                              max_period=max_period).view(*orig_shape, dim)
