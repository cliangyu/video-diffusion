...
parser.add_argument('mask_path', type=str, help="Where to save the generated videos/coords.")
args = parser.parse_args()


batch_obs_indices, batch_lat_indices = map(np.array, torch.load(args.mask_path))
