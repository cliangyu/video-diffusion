...
def main(args, models, diffusions, dataloader, postfix="", dataset_indices=None):
    assert args.obs_length == 36, "Inference for observation lengths other than 36 is not implemented."
...
if __name__ == "__main__":
    ...
    dataset = locals()[f"get_{args.dataset_partition}_dataset"](dataset_name=model_args.dataset)
    ...
    main(args, models, diffusions, dataloader, postfix=postfix, dataset_indices=args.indices)
