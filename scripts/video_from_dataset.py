...
if __name__ == "__main__":
    ...
    parser.add_argument("--length", type=int, default=None,
                        help="Length of the videos. If not specified, it will save the whole video.")
    args = parser.parse_args()
    args.out = Path(args.out) / args.dataset / f"{args.dataset_partition}_{args.i}_{args.length}.npy"
    ...
    video = (video - drange[0]) / (drange[1] - drange[0])  * 255 # video with pixel values in [0, 255]
